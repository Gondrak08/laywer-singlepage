...
export default function QA() {
    ...
    return (
        <section className="w-full h-full bg-app-blue py-16 flex flex-col justify-center gap-5 ">
            <h3 className="text-center text-2xl md:text-4xl text-bold text-white ">Você tem algum <span className="text-app-yellow">destes problemas?</span></h3>
            <div className="container mx-auto w-full h-full flex flex-col gap-12">
