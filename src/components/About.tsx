...
export default function About(){
    return(
        <section className="w-full h-full bg-app-black py-24">
            <div className="container mx-auto h-full grid grid-cols-1 md:grid-cols-2 gap-16 px-2 md:px-0 animation">
                ...
                <div  className="w-full h-full flex flex-col gap-3 animation">
